...
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_psopremium/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_psopremium/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_psopremium/license/gate'),
        ]);
